...
static uint8_t ext_adv_pattern_1[] = {
    0x02, 0x01, 0x06,// flag LE普通可发现模式,不支持BR/EDR(经典蓝牙)
	0x03, 0x03, 0xab, 0xcd,// 完整的服务id 16bit
	0x03, 0x03, 0x18, 0x12,// 完整的服务id 16bit
	0x11, 0X09, 'e', 's', 'p', '3', '2', 'h', '2', '-', 'B', 'L', 'E', '5', '0', '-', 'S', '\0',//完整的名字
};
#endif
